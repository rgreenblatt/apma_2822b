...
template <typename Scalar> void compute_gradient_values(Scalar *grad_vals) {
...
void compute_element_matrix_and_vector(ElemData<Scalar> &elem_data) {
...
template <typename Scalar>
void compute_element_matrix_and_vector(ElemDataPtr<Scalar> &elem_data) {
  Hex8::diffusionMatrix_symm(elem_data.elem_node_coords, elem_data.grad_vals,
                             elem_data.elem_diffusion_matrix);
  Hex8::sourceVector(elem_data.elem_node_coords, elem_data.grad_vals,
                     elem_data.elem_source_vector);
