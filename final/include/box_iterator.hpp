...
public:
  ...
  BoxIterator &operator=(const BoxIterator &src) {
    box_[0][0] = src.box_[0][0];
    box_[0][1] = src.box_[0][1];
    box_[1][0] = src.box_[1][0];
    box_[1][1] = src.box_[1][1];
    box_[2][0] = src.box_[2][0];
    box_[2][1] = src.box_[2][1];
    x = src.x;
    y = src.y;
    z = src.z;
    return *this;
...
private:
  BoxIterator(const Box &box, bool at_end = false)
      : x(box[0][0]), y(box[1][0]), z(box[2][0]), box_() {
    box_[0][0] = box[0][0];
    box_[0][1] = box[0][1];
    box_[1][0] = box[1][0];
    box_[1][1] = box[1][1];
